    ...
    return [
      {
        ...
        searchTags: ['The Joe Budden Podcast - The Joe Budden Network', 'The Joe Budden Network'],
        summary:
      ...
      },
      {
        ...
        searchTags: ['R&B Money - The Black Effect and iHeartPodcasts', 'The Black Effect and iHeartPodcasts'],
      ...
      },
      {
        ...
        searchTags: ['Friday Night Karaoke - Friday Night Karaoke', 'Friday Night Karaoke'],
        summary:
